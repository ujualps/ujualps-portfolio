    ...
    <section className="flex flex-col items-center justify-center text-center h-screen px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl space-y-8 relative z-10">
        <div className="mb-6 opacity-0 animate-[fadeInUp_1s_ease-out_0.1s_forwards]">
          <h1 className="text-6xl md:text-8xl font-extrabold mb-6 tracking-tight bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 bg-clip-text text-transparent leading-none drop-shadow-sm">
            Tales of UJ
          </h1>
        </div>

        <p className="text-xl md:text-2xl text-neutral-600 max-w-3xl mx-auto leading-relaxed font-light opacity-0 animate-[fadeInUp_1s_ease-out_0.3s_forwards]">
          Stories captured through light. Photography that seeks the narratives
          etched in every moment, every face, every experience.
        </p>

        {/* Action Buttons */}
        <div className="flex flex-wrap items-center justify-center gap-4 mt-12 opacity-0 animate-[fadeInUp_1s_ease-out_0.5s_forwards]">
          <Button
            asChild
            variant="outline"
            size="lg"
